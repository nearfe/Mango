...
public class Config {
    ...
    private static final String HEADER = "This is the main configuration file for Mango.\n"
    ...
    public Config() {
        ...
        try {
            ...
            Bridge.version = (String) prop.getOrDefault("version", "Unknown");
        }
        ...
        this.config.options().header(Config.HEADER);
